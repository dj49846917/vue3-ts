          ...
          <tr class="top">
            <td class="v-m" colspan="2" width="55%">
              ...
              <div class="t-l col-lg-4 fr title textR">
                当前价：<span class="p-price">3000</span> 元
              </div>
            </td>
            <td class="v-m red" width="22%">拍卖中</td>
            <td class="v-m operate" width="23%">
              <a class="btn btn-danger" href="">立即出价</a>
            </td>
          </tr>
          <tr class="bottom">
            <td class="v-m line_none" colspan="2" width="55%">
              ...
              <div class="t-l col-lg-4 fr title textR">
                <span class="p-price">3000</span> 元
              </div>
            </td>
      ...
      <table class="mt20">
        ...
        <tbody>
          <tr class="top">
            ...
            <td class="v-m" width="22%">已流拍</td>
            <td class="v-m operate" width="23%">
              <a class="btn btn-default" href="">查看保证金</a>
            </td>
          </tr>
          <tr class="bottom">
            <td class="v-m line_none" colspan="2" width="55%">
